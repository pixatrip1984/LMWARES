...
export function validatePackageJson(source) {
  // Keep the textual duplicate-key check independent of the checkout's line endings.
  ...
  const scriptsMatch = normalizedSource.match(/\n  "scripts": \{([\s\S]*?)\n  \},\n  "devDependencies":/u);
